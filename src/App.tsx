		...
		<>
				...
				<div class="container gap-2">
					...
					<div class="me-auto position-relative">
						...
						<Show when={isSearchMode()}>
							<button
								class="btn-close small position-absolute top-50 end-0 translate-middle-y me-2"
								onClick={() => clearSearch()}
							></button>
						</Show>
					</div>
								...
								fallback={
									<Show
										...
										fallback={
											<button
												...
												disabled
												aria-label="Initialising Google Sign-In"
											>
									...
									>
										<button
											class="btn btn-outline-secondary btn-sm"
											disabled
											title="Google Sign-In library could not be loaded"
										>
							...
							>
								...
								>
									<div class="position-relative">
										<button
											class="d-flex flex-nowrap btn btn-outline-secondary btn-sm"
											onClick={() => toggleSyncMenu()}
											disabled={isSyncing()}
											title={syncError() ? `Sync error: ${syncError()}` : "Google Drive Sync"}
										...
										<Show when={showSyncMenu()}>
											<div class="dropdown-menu show sync-dropdown">
												...
												<div class="dropdown-divider"></div>
												<button
													class="dropdown-item sync-dropdown-item"
													onClick={() => handleSave()}
													disabled={isSyncing()}
												>
												...
												<div class="dropdown-divider"></div>
												<button
													class="dropdown-item sync-dropdown-item text-danger"
			...
			<Show when={lastSyncMessage()}>
				<Toast
					...
					timeStamp={lastSyncMessage()!.timeStamp}
